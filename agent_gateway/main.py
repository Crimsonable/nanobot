...
from agent_gateway.config import APP_HOST, APP_PORT, BUCKET_COUNT
...
from agent_gateway.services.router_service import GatewayRouter
...
async def _route_message(
    *,
    ...
    binding = await router.route_inbound(
        frontend_id,
        user_id,
        {
...
def main() -> None:
    uvicorn.run("agent_gateway.main:app", host=APP_HOST, port=APP_PORT)
