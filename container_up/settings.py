...
BUCKET_COMMON_ROOT = Path(_required_env("BUCKET_COMMON_ROOT")).expanduser()
...
BUCKET_MAX_INSTANCES_PER_BUCKET = _int_env(
    "BUCKET_MAX_INSTANCES_PER_BUCKET",
    _int_env("BUCKET_MAX_PROCESSES", 20),
)
...
MINIO_KEY_PREFIX = os.getenv("MINIO_KEY_PREFIX", "").strip()
MINIO_PRESIGN_EXPIRY_SECONDS = _int_env("MINIO_PRESIGN_EXPIRY_SECONDS", 3600)
